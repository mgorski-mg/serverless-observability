...
namespace ServerlessObservability.Providers
{
    public static class AwsClientsSingletonsProvider
    {
        ...
        private static readonly Lazy<IAmazonS3> S3ClientLazy = new Lazy<IAmazonS3>(() => new AmazonS3Client());
        private static readonly Lazy<IAmazonSQS> SqsClientLazy = new Lazy<IAmazonSQS>(() => new AmazonSQSClient());
        private static readonly Lazy<IAmazonLambda> LambdaClientLazy = new Lazy<IAmazonLambda>(() => new AmazonLambdaClient());
    }
}
